                                            ...
                                            <div className="post-navigation__prev">
                                                <div className="post-navigation__img">
                                                    ...
                                                    <div className="post-navigation__img-hover">
                                                        <Link href="/KeywordResearchForSEO"><i className="fa-regular fa-arrow-left"></i></Link>
                                                    </div>
                                                </div>
                                                <div className="post-navigation__content">
                                                    <h4><Link href="/KeywordResearchForSEO">SEO Checklist Steps Optimize Your Business.</Link></h4>
                                        ...
                                        <div className="col-xl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                            <div className="post-navigation__next">
                                                <div className="post-navigation__img">
                                                    ...
                                                    <div className="post-navigation__img-hover">
                                                        <Link href="/KeywordResearchForSEO"><i className="fa-regular fa-arrow-right"></i></Link>
                                                    </div>
                                                </div>
                                                <div className="post-navigation__content">
                                                    <h4><Link href="/KeywordResearchForSEO">The Role of SEO in Brand Building and Online.</Link></h4>
                                                    <span><i className="fa-light fa-calendar-lines"></i>March 29,2023</span>
                                                </div>
                                            </div>
                                        </div>
...
export default KeywordResearchForSEO;
